...
- [Phase milestone](https://github.com/Bill6006/tyree-life-command-center-next/milestone/1)
- [Phase 0 issue](https://github.com/Bill6006/tyree-life-command-center-next/issues/1)
- [Phase 1 issue](https://github.com/Bill6006/tyree-life-command-center-next/issues/2)
- [Actions](https://github.com/Bill6006/tyree-life-command-center-next/actions)
- [Pages deployment](https://github.com/Bill6006/tyree-life-command-center-next/actions/workflows/pages.yml)
...
| Phase 4 — App shell, navigation, guides, and automation | Complete | [Report](docs/reports/phase-4.md), [tracking issue](https://github.com/Bill6006/tyree-life-command-center-next/issues/5) |
| Phase 5 — Today, Minimum Wins, and move lifecycle | Complete | [Report](docs/reports/phase-5.md), [tracking issue](https://github.com/Bill6006/tyree-life-command-center-next/issues/6) |
| Phase 6 — Forecast, evidence, capacity, and learning | In progress | [Tracking issue](https://github.com/Bill6006/tyree-life-command-center-next/issues/7) |
| Phase 7 — Domain screens | Not started | — |
| Phase 8 — Data, exports, diagnostics, and acceptance | Not started | — |
